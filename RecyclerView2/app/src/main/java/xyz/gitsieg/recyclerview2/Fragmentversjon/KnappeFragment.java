...
public class KnappeFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof KnappeFragment.OnMenyButtonListener) {
            ...
            throw new RuntimeException(context.toString() + "må implementere KnappeFragment.OnMenyButtonClicked");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_knappe, container, false);

        fylkeKnapp = layout.findViewById(R.id.fylkeKnapp);
