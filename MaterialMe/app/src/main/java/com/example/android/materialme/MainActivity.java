...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create drag directions
        int dragDirs = ItemTouchHelper.START | ItemTouchHelper.END | ItemTouchHelper.UP | ItemTouchHelper.DOWN;

        // Create swipe directions
        int swipeDirs = ItemTouchHelper.START | ItemTouchHelper.END;

        // Create ItemTouchHelper and implement onMove and onSwiped methods.
